    ...
    <body>
        <nav class="barraNavegacion navbar navbar-expand-md navbar-dark fixed-top">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="index.php?c=Empleado&f=index">Servicios</a></li>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="index.php?c=Login&f=InicioSesion">Login</a></li>
        ...
        <h1 class="jumbotron text-center titNivel1">
            ...
            Productos de House Cleaning </h1>
